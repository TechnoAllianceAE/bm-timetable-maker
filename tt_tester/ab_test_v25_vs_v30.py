#!/usr/bin/env python3
"""
A/B Testing: v2.5 vs v3.0 Timetable Engine
Tests both versions on identical data across all 5 configurations and generates detailed HTML report.
"""
...
from src.models_phase1_v30 import (
    Class as ClassV30,
    Subject as SubjectV30,
    Teacher as TeacherV30,
    TimeSlot as TimeSlotV30,
    Room as RoomV30,
    RoomType as RoomTypeV30,
    V30Validator,
    get_version_info
)
